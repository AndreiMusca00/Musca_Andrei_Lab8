...
namespace Musca_Andrei_Lab8.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Musca_Andrei_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Musca_Andrei_Lab8Context context,
